<template>
	<section
		id="services"
		class="page flex h-max w-full flex-col items-center justify-center gap-8 pt-[100px]"
	>
		<h1 class="hidden text-3xl font-bold">What I can do for you</h1>
...
function handleNext() {
	if (page.value === numOfPages) return;
	page.value++;
}
</script>
